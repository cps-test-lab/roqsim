...
| license | assets |
| --- | --- |
| BSD-3-Clause | Spot, xArm 7 and the Interbotix ViperX 300 / WidowX 250 (MuJoCo Menagerie; the last two © Trossen Robotics), Unitree G1 ×2, UR5e/UR10e/Robotiq (ROS-Industrial), Jackal, Husky |
