...
(also wired into `make venv`) or set SPOT_POLICY_PATH before launching.
    ...
    ros2 launch roqsim_nav2_example nav2_spot.launch.py
    ros2 launch roqsim_nav2_example nav2_spot.launch.py gui:=true   # MuJoCo viewer + rviz2
"""
...
def generate_launch_description():
    ...
    default_world = os.path.join(pkg, "worlds", "spot_nav2.yaml")
    default_map = os.path.join(pkg, "maps", "empty_room.yaml")
    default_params = os.path.join(pkg, "params", "nav2_params_spot.yaml")
