...
def test_world_yaml_round_trips_and_places_the_robot_first(tmp_path):
    ...
    # `name` is a sibling of the plugin ref, like every other generated entry -- nested
    # inside `spawn_robot` it would be a stray config key instead of the entry's label.
